...
public class OutputBook {
    ...
    public String toString() {
        return "OutputBook(tempA=" + this.getTempA() + ", tempB=" + this.getTempB() + ", tempC=" + this.getTempC() + ", tempD=" + this.getTempD() + ", tempE=" + this.getTempE() + ", tempF=" + this.getTempF() + ", checkType=" + this.getCheckType() + ", aircraft=" + this.getAircraft() + ", thresholdUsed=" + this.getThresholdUsed() + ", controlDim1=" + this.getControlDim1() + ", dueAmount1=" + this.getDueAmount1() + ", controlDim2=" + this.getControlDim2() + ", dueAmount2=" + this.getDueAmount2() + ", controlDim3=" + this.getControlDim3() + ", dueAmount3=" + this.getDueAmount3() + ")";
    }
}
